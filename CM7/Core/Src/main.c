...
#define ADC_BUFFER_LENGTH  2   // [0] = VREFINT, [1] = TEMPSENSOR (for example)
uint32_t adc_buffer[ADC_BUFFER_LENGTH];

float vref_mV = 0.0f;   // Calculated Vref+ in mV
float temp_C = 0.0f;
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		...
		} // or wait for timer period

		//	vref_mv = __HAL_ADC_CALC_VREFANALOG_VOLTAGE(adc_buffer[0],
		//		ADC_RESOLUTION_16B);

		//temperature = __HAL_ADC_CALC_TEMPERATURE(vref_mv, adc_buffer[1],
		//	ADC_RESOLUTION_16B);
